    ...
    <>
      ...
      <div className="page">
        <div className="header">
          ...
          <p>
            All channels from the Remote Terminal export, enriched with
            community metadata.
          </p>
        </div>
        ...
        <div className="rtfm-warning">
          ...
          <p>
            The fork has a complete channel managament module, a key management
            system, overhauled map and tons more additions/tweaks.
          </p>
          <p>
            Most of the channels and information on this page comes directly
            from the RTfM app. This page was made just to show "my local"
            information to friends. And then i had too much coffee.
          </p>
          <p>
            When coming from the parent branch of Remote-Term, make sure you
            back-up your database, it will run fine (probably), but i'd hate for
            your to lose historical information.
          </p>
          <div className="danger-notice">
            <p>⚠ Important warning about RTfM</p>
            <p>
              Use this tool only with a <strong>dedicated companion</strong> for
              the machine it runs on. To work around MeshCore channel/contact
              limits, it may{" "}
              <strong>pull, overwrite, and delete contacts/channels</strong>{" "}
              during import/export and sync operations.
              <strong>
                {" "}
                Do not use it on your main everyday companion unless you fully
        ...
        <details className="info-panel" open>
          ...
          <div className="info-panel-body">
            <div className="info-box">
              ...
              <p>
                Quick references for MeshCore NL, region naming and related
                github repo's
              </p>
              <div className="quick-links">
                <a
                  className="quick-link"
                  href="https://meshwiki.nl/wiki/The_switch/draft"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  SF8 → SF7 Switch E.T.A. 9th of May
                </a>
                <a
                  className="quick-link"
              ...
              <h4 style={{ color: "#93c5fd" }}>
                MeshCore Nederland Communities
              </h4>
              <p>Quick references for useful MeshCore NL Communities</p>
              <div className="quick-links">
			    <a
                  className="quick-link"
                  href="https://cornmeister.nl"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Cornmeister
            ...
            <div className="info-box warn">
              ...
              <p>
                When adding or editing <strong>scopes</strong>, please follow
                the official MeshWiki region guideline. This keeps naming clear
                and prevents duplicate, random or incompatible scope structures.
              </p>
            </div>
            <div className="info-box danger">
              <h4 style={{ color: "#fbbf24" }}>⚠ Github pages warning</h4>
              <p>
                Changes made on this GitHub Pages version are stored{" "}
                <strong>only in your browser</strong>. If you edit metadata
                here, export it before leaving or refreshing if you want to keep
                your work safely backed up.
              </p>
            </div>
            <div className="info-box">
              <h4 style={{ color: "#93c5fd" }}>Cornmeister MQTT</h4>
              <p>
                Connect your node to the Cornmeister MQTT broker to share
              ...
              >
                <tbody>
                  <tr>
                    <td style={{ color: "#94a3b8", paddingRight: "1rem" }}>
                      Server
                    </td>
                    <td>
                      <code>mqtt.cornmeister.nl</code>
                    </td>
                  </tr>
                  <tr>
                    <td style={{ color: "#94a3b8" }}>Port (TLS)</td>
                    <td>
                      <code>8883</code>
                    </td>
                  </tr>
                  <tr>
                    <td style={{ color: "#94a3b8" }}>Port (plain)</td>
                    <td>
                      <code>1883</code>
                    </td>
                  </tr>
                  <tr>
                    <td style={{ color: "#94a3b8" }}>Transport</td>
                    <td>
                      <code>TCP</code>
                    </td>
                  </tr>
            ...
            <div className="info-box">
              ...
              <p>
                This page combines a{" "}
                <strong>Remote Terminal for MeshCore export</strong> with
                manually curated community metadata. If you want to improve
                channels, scopes or notes, update the repo or submit a pull
                request.
              </p>
            </div>
          </div>
